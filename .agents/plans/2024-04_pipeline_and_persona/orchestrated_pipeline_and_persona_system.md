...
| 파일 | 내용 |
|------|------|
| `docs/philosophy/ABOUT_KR.md` | 섹션 5 제목 "두 가지 차별점" → "세 가지 차별점". `셋째, 페르소나:` 항목 추가 |
| `docs/philosophy/ABOUT.md` | 섹션 5에 아이템 6 `Persona: Expressing Your Knowledge Model` 추가 (목록 형식 통일) |
| `docs/guides/USER_GUIDE_KR.md` | "Curator 페르소나" (L226) / "Artist 페르소나" (L240) 섹션 추가. `wiki persona` 명령어 사용법 포함 |
| `docs/guides/USER_GUIDE.md` | 동일 내용 영문 |
| `docs/guides/MCP_USER_GUIDE_KR.md` | `curator_update_artist_persona` / `curator_update_curator_persona` 툴 문서 추가 (L87) |
| `docs/guides/MCP_USER_GUIDE.md` | 동일 내용 영문 |
| `docs/specs/system_behavior/SYSTEM_BEHAVIOR_v0.1.0.md` | Persona System 섹션 추가 (L149). 2-tier 구조, 주입 포인트 전체 목록, `wiki query` fallback 동작 |
| `docs/specs/curator_schema/SCHEMA_v0.1.0.md` | Curator/Artist persona 스키마 정의 (L424+) |
| `README_KR.md` | 퀵스타트 step 3: `wiki persona update` 언급 추가 |
| `README.md` | 동일 내용 영문 |
...
| `src/curator/cli.py` | `_run_curator_persona_wizard`, `_run_artist_persona_wizard`, `wiki persona` 명령어 |
...
| `docs/philosophy/ABOUT_KR.md` | 섹션 5 제목/본문 페르소나 항목 추가 |
| `docs/philosophy/ABOUT.md` | 섹션 5 아이템 6 페르소나 추가 |
| `docs/guides/USER_GUIDE_KR.md` | Curator/Artist 페르소나 섹션 신규 |
| `docs/guides/USER_GUIDE.md` | 동일 영문 |
| `docs/guides/MCP_USER_GUIDE_KR.md` | 페르소나 MCP tools 문서 |
| `docs/guides/MCP_USER_GUIDE.md` | 동일 영문 |
| `docs/specs/system_behavior/SYSTEM_BEHAVIOR_v0.1.0.md` | Persona System 섹션 추가 |
| `docs/specs/curator_schema/SCHEMA_v0.1.0.md` | Curator/Artist persona 스키마 정의 |
| `README_KR.md` | 퀵스타트 persona 언급 추가 |
| `README.md` | 동일 영문 |
