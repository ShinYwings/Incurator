...
`.agents/plans/2024-05_v0.2.0_system_build/INCURATOR_SYSTEM_BUILD.md` must remain the top-level build plan.
...
`.agents/plans/2024-05_v0.2.0_mcp_scenarios/mcp_scenarios.md`
...
- `docs/guides/DEV_SCRIPTS_GUIDE.md`
- `docs/guides/CONTRIBUTION_GUIDE_KR.md`
