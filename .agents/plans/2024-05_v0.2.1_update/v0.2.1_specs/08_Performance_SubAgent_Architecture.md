...
**provider 가정**: Ollama(로컬), Antigravity(`agy`), Claude CLI(`claude`) 모두 지원.
...
`.agents/plans/2024-04_pipeline_and_persona/orchestrated_pipeline_and_persona_system.md` Phase 3에서
