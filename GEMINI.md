...
3. **The Document Sandbox**: You fully manage `.agents/` tracking files, `GEMINI.md`, `CHANGELOG.md`, and the `docs/` folder. You MUST immediately `git add` and `git commit` any rule or documentation updates you make. Do not leave your chore items uncommitted in the working tree.
