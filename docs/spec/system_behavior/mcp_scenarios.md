# Incurator MCP Operational Scenarios (v0.2.0)
...
*   **Logic Flow**:
    ...
    3.  If the source is indexed, the plugin may call `curator_search_source(query, source_id/source_path, limit=N)` to retrieve backend RAG hits with page provenance.
