...
// Measured: `$read_file$()` -> permissions gone; `read_file()` -> survives.
// That is the whole reason "jetski: no output produced" kept recurring; every
// previous fix reshaped the prompt around a permission that was never granted.
