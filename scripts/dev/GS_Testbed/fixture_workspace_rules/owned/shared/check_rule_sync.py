#!/usr/bin/env python3
"""Check incurator managed rule blocks for this workspace."""
...
SHARED = ".agents/curator/shared/rules.md"
REQUIRED = [
    SHARED,
...
def main() -> int:
    ...
    if errors:
        print("incurator rule sync check failed:")
        for error in errors:
            print(f"- {error}")
        return 1

    print("incurator rule sync check passed.")
    return 0
