---
citekey: EWAsplatting_Zwicker2002
authors: ["Zwicker, M.", "Pfister, H.", "van Baar, J.", "Gross, M."]
year: 2002
url: "https://ieeexplore.ieee.org/document/1021576"
zotero_link: "zotero://select/library/items/N553UVKA"
tags: [paper-review, journalArticle]
---
---
...
> [!info] Core Contribution 
> %% - **Problem:** > - **Methodology:** > - [!example] Prerequisites (Foundations) 
> - *(e.g., Signal Processing, Projective Mapping, Optimal Transport)* > [!math] Mathematical Rigor 
> - **Key Formulation:** > $$\mathcal{L} = \lambda_{RGB} \mathcal{L}_{RGB} + \lambda_{D} \mathcal{L}_{D}$$
> 	- $\mathcal{L}_{RGB}$: Photometric loss
> 	- $\mathcal{L}_{D}$: Depth consistency loss
> 	-
> - **Assumptions & Distortions:** > 	- *(e.g., Local affine approximation validity, lens/projective distortions)* >   %%
>   
> %% begin Core Contribution %%
> 
> %% end Core Contribution %%
> 

> [!question] Critique & Pipeline Integration 
> %% - **Limitations:** 
> - **Application:** 
> - *(e.g., Integration with Temporal Superpixel, COLMAP-free initialization)*  %%
>   
> %% begin Critique & Pipeline Integration  %%
> 
> %% end Critique & Pipeline Integration  %%
> 
...
> [!quote|yellow] #1 [(Backlink: p.2)](zotero://open-pdf/library/items/HD68VDJK?page=2&annotation=F53FLLJX) (Last modified: 2026-04-28 04:02)
> ![[05_Assets/Zotero Assets/EWAsplatting_Zwicker2002/image-3-x310-y371.png]]
>
> **✍️ Note:** 
...
3D Gaussian Splatting (3DGS)를 깊게 이해하기 위해, [EWA Splatting](zotero://select/library/items/N553UVKA)을 읽고 수식 유도 중심으로 제가 이해한 내용을 바탕으로 정리했습니다. 틀린 부분이 있으면 지적바랍니다.
> 전체 과정을 정확히 이해하려면 [Fundamentals of Texture Mapping and Image Warping]([05_Assets/Zotero Assets/EWAsplatting_Zwicker2002/](obsidian://open?vault=Documents&file=05_Assets%2FZotero%20Assets%2FEWAsplatting_Zwicker2002%2FFundamentals%20of%20Texture%20Mapping%20and%20Image%20Warping.pdf))을 읽어보는 것을 추천합니다.
...
<img src="05_Assets/Zotero Assets/EWAsplatting_Zwicker2002/figure1.jpg" width="60%" height="60%">
<i>출처: Udacity</i>
</p>
...
<p align="center" style="color:gray">
<img src="05_Assets/Zotero Assets/EWAsplatting_Zwicker2002/figure3.jpg" width="80%" height="80%">
</p>
...
<p align="center" style="color:gray">
<img src="05_Assets/Zotero Assets/EWAsplatting_Zwicker2002/figure4.jpg" width="80%" height="80%">
</p>
...
<p align="center" style="color:gray">
<img src="05_Assets/Zotero Assets/EWAsplatting_Zwicker2002/figure2.jpg" width="60%" height="60%">
<i>출처: https://canvas4sh.tistory.com/324</i>
</p>
...
1. Nyquist 이론에 기반한 Sampling  
    **체크무늬 식탁보** 또는 **청바지의 주름** 을 표현할 수 있을 만큼 충분히 많은 Sample Points을 생성해야합니다. 이런 성질을 고려한 주파수를 샘플링 이론에서 Nyquist 주파수라고 합니다. 만약 그림 (b)와 같이 일정 간격으로 Grid 형태의 Sample point를 만드는 경우, High Frequency 성분에 맞춰 샘플링 주파수를 조정해야 합니다. 
...
<p align="center" style="color:gray">
<img src="05_Assets/Zotero Assets/EWAsplatting_Zwicker2002/figure5.jpg" width="80%" height="80%">
</p>
...
<p align="center" style="color:gray">
<img src="05_Assets/Zotero Assets/EWAsplatting_Zwicker2002/figure6.jpg" width="80%" height="80%">
</p>
...
<p align="center" style="color:gray">
<img src="05_Assets/Zotero Assets/EWAsplatting_Zwicker2002/figure7.jpg" width="80%" height="80%">
</p>
...
> c.f. Importance sampling을 사용하는 경우, 신호 처리 기반 이론을 적용할 수 없습니다. [이 블로그](https://leeyngdo.github.io/blog/computer-graphics/2024-04-09-gaussian-splatting/)에서 non-uniform sampling일 경우를 참조바랍니다. 
> 
...
<p align="center" style="color:gray">
<img src="05_Assets/Zotero Assets/EWAsplatting_Zwicker2002/figure8.jpg" width="60%" height="60%">
</p>
...
<p align="center" style="color:gray">
<img src="05_Assets/Zotero Assets/EWAsplatting_Zwicker2002/figure9.jpg" width="60%" height="60%">
</p>
...
<p align="center" style="color:gray">
<img src="05_Assets/Zotero Assets/EWAsplatting_Zwicker2002/figure18.jpg" width="40%" height="40%">
</p>

> **Gaussian Splatting 과 관련성**  
> 3DGS는 Volume resampling 방법으로부터 아이디어를 얻은 알고리즘입니다. (수식은 Surface resampling 개념도 사용합니다.)  
> 2DGS는 Surface resampling 방법으로부터 아이디어를 얻은 알고리즘입니다.
...
EWA Splatting 에서 소개되는 Ray space는 임의의 3차원 공간(좌표계)을 도입하여, 3차원 공간의 gaussian을 2D 공간의 사영된 gaussian과 선형 변환이 가능하게 도와줍니다. Ray space에서 Screen space으로의 최종 변환에는 depth, color, shading을 포함한 최종 렌더링 이미지 생성이 포함됩니다.

<p align="center" style="color:gray">
<img src="05_Assets/Zotero Assets/EWAsplatting_Zwicker2002/figure10.jpg" width="60%" height="60%">
<i>출처: https://learnopencv.com/3d-gaussian-splatting/</i>
</p>

위 그림과 같이, 카메라 공간으로부터 Ray space 변환은 Non-linear 입니다. 왜냐하면 카메라 공간의 수평 및 수직 성분을 깊이에 따라 나누기 때문입니다.
...
<p align="center">
<img src="05_Assets/Zotero Assets/EWAsplatting_Zwicker2002/figure11.jpg" width="40%" height="40%">
</p>
...
<p align="center" style="color:gray">
<img src="05_Assets/Zotero Assets/EWAsplatting_Zwicker2002/figure12.jpg" width="60%" height="60%">
<i>출처:https://www.cambridgeincolour.com/tutorials/image-projections.html</i>
</p>

그렇기 때문에, EWA Splatting에서 Camera Space $\rightarrow$ Ray space 맵핑 함수 $\phi(u)$는 선형 공간에서 비선형적 공간으로 변환이기에 Affine transformation을 직접 사용하기 어렵습니다. 대신에, 비선형 변환을 선형 변환으로 근사한 Local affine transformation을 사용합니다.
...
<p align="center" style="color:gray">
<img src="05_Assets/Zotero Assets/EWAsplatting_Zwicker2002/figure14.jpg" width="60%" height="60%">
<i>출처: https://angeloyeo.github.io/2020/07/24/Jacobian.html</i>
</p>

#### 3.1.2. Splatting 알고리즘

<p align="center">
<img src="05_Assets/Zotero Assets/EWAsplatting_Zwicker2002/figure19.jpg" width="60%" height="60%">
</p>
...
<p align="center" style="color:gray">
<img src="05_Assets/Zotero Assets/EWAsplatting_Zwicker2002/figure13.jpg" width="60%" height="60%">
<i>(왼쪽) Volume Rendering, (오른쪽) Splatting</i>
</p>
...
<p align="center" style="color:gray">
<img src="05_Assets/Zotero Assets/EWAsplatting_Zwicker2002/figure15.jpg" width="80%" height="80%">
</p>

여기서, $\rho$는 viewing transformation 그리고 $\phi$는 projective mapping 입니다.
...
이 때, Volume data를 구성하는 각 Voxel을 Reconstruction filter $r'_{k}$ 이라고 볼 수 있기 때문에,
...
<p align="center" style="color:gray">
<img src="05_Assets/Zotero Assets/EWAsplatting_Zwicker2002/figure16.jpg" width="60%" height="60%">
</p>
...
<p align="center" style="color:gray">
<img src="05_Assets/Zotero Assets/EWAsplatting_Zwicker2002/figure20.jpg" width="40%" height="40%">
</p>
...
#### 4.1.2. Linear Warp
> [Fundamentals of Texture Mapping and Image Warping]([05_Assets/Zotero Assets/EWAsplatting_Zwicker2002/Fundamentals of Texture Mapping and Image Warping.pdf](obsidian://open?vault=Documents&file=05_Assets%2FZotero%20Assets%2FEWAsplatting_Zwicker2002%2FFundamentals%20of%20Texture%20Mapping%20and%20Image%20Warping.pdf))의 Section 3.5.7 Linaer Filter Warps를 참조했습니다.
...
<p align="center" style="color:gray">
<img src="05_Assets/Zotero Assets/EWAsplatting_Zwicker2002/figure21.jpg" width="70%" height="70%">
</p>
...
<p align="center" style="color:gray">
<img src="05_Assets/Zotero Assets/EWAsplatting_Zwicker2002/figure22.jpg" width="70%" height="70%">
</p>
...
<p align="center" style="color:gray">
<img src="05_Assets/Zotero Assets/EWAsplatting_Zwicker2002/figure23.jpg" width="40%" height="40%">
</p>
...
### 5.1. 렌즈 왜곡
EWA Splatting과 3DGS 경우, Pinhole 모델의 이미지를 입력으로 받기 때문에 렌즈 왜곡에서 자유롭습니다. 
실제 렌즈 왜곡이 적용된 이미지를 입력으로 사용하려면 Local affine transform이 가진 근사 오차 문제를 해결해야 합니다. 자세한 내용은 3DGUT(CVPR 25), Fisheye-GS 를 참조바랍니다.  

### 5.2. 투영 왜곡  
Rendering pipeline이 forward mapping일 때, 3D-2D Projection을 naive한 Affine transform을 쓰면 다음과 같은 결과를 보입니다.

<p align="center" style="color:gray">
<img src="05_Assets/Zotero Assets/EWAsplatting_Zwicker2002/figure24.jpg" width="80%" height="80%">
</p>

그 이유는, 아래 그림과 같이, Image space와 Object space 사이에 어떤 직선을 투영할 때, 각 포인트 간 거리의 스케일이 안맞는 문제가 있기 때문입니다.

<p align="center" style="color:gray">
<img src="05_Assets/Zotero Assets/EWAsplatting_Zwicker2002/figure25.jpg" width="50%" height="50%">
</p>
  
이 현상을 해결하기 위한 가장 대표적인 방법은 Barycentric coordinate를 사용한 Projection interpolation인데 EWA Splatting에서는 이 현상에 대해 해결 방법은 명확히 나온 내용은 없습니다.
하지만 추측을 해보면 Local affine transformation 이 같은 역할을 하는 것으로 추측됩니다. 왜냐하면 이 왜곡을 해결하기 위해 [Fundamentals of Texture Mapping and Image Warping]([https://velog.velcdn.com/images/shinywings/post/54ea8f5a-541b-4c04-8acb-382696b5cca2/image.pdf](obsidian://open?vault=Documents&file=05_Assets%2FZotero%20Assets%2FEWAsplatting_Zwicker2002%2FFundamentals%20of%20Texture%20Mapping%20and%20Image%20Warping.pdf))에서도 Incremental Techiques for Screen Order Scanning 방법을 사용하는데 , 아래 전문의 Highlight 친 부분을 보면 Local affine transformation 과 수식이 비슷합니다. 그래서 명확하진 않지만 local affine transformation도 비슷한 효과를 가져온 것이 아닐까 생각합니다.  

<p align="center" style="color:gray">
<img src="05_Assets/Zotero Assets/EWAsplatting_Zwicker2002/figure26.jpg" width="60%" height="60%">
</p>
...
%% Import Date: 2026-05-01T07:17:43.283+09:00 %%
