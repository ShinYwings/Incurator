# LLM-Wiki Shared Workspace Rules

These rules are the llm-wiki contract for `{{project_name}}`.
...
2. If llm-wiki MCP is available, search with `WORKSPACE_PATH` scoped to this
